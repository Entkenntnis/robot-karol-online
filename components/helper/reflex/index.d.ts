...
export declare class ReflexContainer extends React.Component<
...
export declare class ReflexElement extends React.Component<
  ReflexElementProps,
  any
> {}
...
export declare class ReflexSplitter extends React.Component<
  ReflexSplitterProps,
  any
> {}
