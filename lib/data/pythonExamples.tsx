...
export const pythonKarolExamples = [
  ...
  { title: 'Bedingte Logik', link: 'spacer', color: 'text-orange-600' },
  ...
  { title: 'Anwendung & Module', link: 'spacer', color: 'text-sky-600' },
  { title: 'Verfolger', link: '#U2CR' },
  { title: 'Scanner', link: '#XGCF' },
  { title: 'Kunst-Generator', link: '#DASK' },
  { title: 'Mitternachtsformel', link: '#VHMG' },
  { title: 'Objektorientierung', link: 'spacer', color: 'text-blue-600' },
  { title: 'Glider', link: '#WK3C' },
  { title: 'Weitere Beispiele', link: 'spacer', color: 'text-purple-600' },
