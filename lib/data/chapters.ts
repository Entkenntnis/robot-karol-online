    ...
    quests: [
      ...
      },
      {
        ...
        content: {
          ...
          title: 'b) Papagei',
          description:
            'Dein Programm soll die Eingabe von Karol speichern und wieder ausgeben, wie ein Papagei. Dafür benötigst du eine Variable, diese kannst du so anlegen:\n\n```py\nwort = input()\n```\n\nWenn Karol was sagt, ist ihre Antwort jetzt in der Variable `wort` gespeichert.\n\nDu kannst diese Variable wieder ausgeben:\n\n```py\nprint(wort)\n```',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'c) Echo',
          description:
            'Speichere das Wort von Karol in einer Variable und gib es dreimal als Echo aus:\n\n```py\nwort = input()\nprint(wort)\n...\n```',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          title: 'a) Schleife',
          description:
            'Sage 10 Mal "Buh!". Nutze eine Schleife:\n\n```py\nfor i in range(...):\n    ...\n```',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'b) Aufrufer',
          description:
            'Frage nach der Anzahl der Personen und gib für jede Person eine Nachricht aus.\n\nNutze für die Eingabe `input` und `int`.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'c) Beatbox',
          description:
            'Na Karol, mit einer Schleife sollte man doch auch etwas Musik machen können, oder?',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          title: 'a) Dart 1',
          description:
            'Bringe die Zeilen in die richtige Reihenfolge:\n\n- `print(punktzahl)`\n- `punktzahl = 501`\n- `wurf = int(input())`\n- `print("Neue Runde")`\n- `punktzahl = punktzahl - wurf`\n',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'b) Dart 2',
          description:
            'Erweitere das Programm von Dart 1 für **drei** Würfe. Nutze `for i in range(...)`.\n\n<details>\n<summary>Vorlage zum Kopieren</summary>\n```py\npunktzahl = 501\nprint("Neue Runde")\nwurf = int(input())\npunktzahl = punktzahl - wurf\nprint(punktzahl)\n```\n</details>',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'c) Dart 3',
          description:
            'Es ist gar nicht so einfach, die Zahlen schnell zu multiplizieren. Python kann mit dem `*`-Operator genau das übernehmen. Frage Zahl und Faktor ab und gib das Produkt aus.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'd) Summe',
          description:
            'Eine Variable kann für viele Dinge verwendet werden, z.B. auch um die Summe einiger Zahlen zu berechnen.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          title: 'UMFRAGE',
          description:
            'Bei dieser Aufgabe geht es nicht um Ellie, sondern mehr um dich. Wie geht es dir beim Lernen? Wie kann ich dir helfen, das Lernen noch besser zu gestalten?\n\nFülle die Umfrage aus, indem du die Variablen auf den passenden Wert setzt. Wenn du fertig bist, klicke auf `Start` und deine Antworten werden eingesendet.',
          tasks: [
            {
              title: 'Einsenden',
              start: {
      ...
      },
      {
        ...
        content: {
          ...
          title: 'a) Geschichte',
          description:
            'Nutze einen f-String als Vorlage, um unterschiedliche Geschichten zu erzählen:\n\n```py\nprint(f"Das ist eine Vorlage und {variable} das ist ein Platzhalter")\n```',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'b) Einmaleins',
          description:
            'Hilf den Kindern beim Einmaleins. Nutze f-Strings und für die Multiplikation das Stern Zeichen: \n\n`ergebnis = a * b`',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Eine Strophe aus einem bekannten Kinderlied, natürlich nur mit alkoholfreiem Bier. ',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          title: 'a) Passwort',
          description:
            'Schreibe ein Python-Programm, dass nach einem Passwort fragt und es überprüft. Nutze `if/else`.\n\nDas korrekte Passwort lautet **trowssaP**.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Frage nach dem Namen der Person. Bei Joel antwortet das Programm: "Verrate mir endlich deinen Plan für meinen Geburtstag.", bei Maria: "Ich möchte endlich mit auf Patrouille."\n\nBei allen anderen Personen sagt das Programm nichts. Nutze zweimal `if`. Lasse das `else` aus.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Dein Programm enthält eine geheime Zahl (psst, sie lautet 7). Karol soll diese Zahl raten und du sagst, ob die Zahl zu hoch oder zu niedrig ist. Bringe diese Code-Zeilen in die richtige Reihenfolge:\n\n`geheim = 7`\n\n`if n < geheim:`\n\n`if n > geheim:`\n\n`n = int(input())`\n\n`print("Rate meine Zahl")`\n\n`print("zu niedrig")`\n\n`print("zu hoch")`',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          description:
            'Eine Farbe des Regenbogen ist meine Lieblingsfarbe. Rate sie! Nutze für dein Programm diese Schnipsel:\n\n`print("Rate meine Lieblingsfarbe!")`\n\n`print("Richtig!")`\n\n`while True:`\n\n`break`\n\n`farbe = input()`\n\n`if farbe == "gelb":`\n\n',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Erweitere das Programm von Regenbogen 1 so, dass bei falschen Eingaben jeweils ein Feedback kommt.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'c) Spaßvogel',
          description:
            'Wer hat nicht Spaß an ein paar Flachwitzen? Dein Programm ist eine Witzmaschine und sie antwortet auf die Eingaben "A", "B" und "C" mit je einem Witz. Die Eingabe "x" beendet dein Programm.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Programmiere einen vollständigen Dart-Punktezähler. Zur Einfachheit startet der Zähler bei 201. Das Spiel muss exakt bei Null enden (siehe Chat 2)',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          description:
            'Schreibe dein Programm, aber anstatt `print` und `input` , nutze meine eigene Sprache mit `blub` und `blab`.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Definiere jetzt eine Sprache mit push und pull. Nutze diese Zeilen:\n\n`def push(text):`\n\n`def pull():`\n\n`return input()`\n\n`print(text)`',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Programmiere nochmal den Papagei, nutze dafür die gegebene Funktion `schreien`.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          title: 'd) Geometrie',
          description:
            'Implementiere die beiden Funktionen `umfang` und `fläche`.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
    ...
    quests: [
      {
        ...
        content: {
          ...
          description:
            'Die neue Version der Wetterwarnung fragt nach der Sichtweite und der Windstärke. Wenn die Sicht geringer ist als 100 Meter **oder** der Wind stärker als 35 km/h, dann gib eine Wetterwarnung aus.\n\nFülle Zeile 4 mit der Bedingung aus.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
      ...
      },
      {
        ...
        content: {
          ...
          description:
            'Wenn die Sicht geringer ist als 500 Meter **und** der Wind stärker ist als 25 km/h, dann werden die Routen verkürzt.\n\nErgänze Zeile 6 mit einer passenden Bedingung.',
          tasks: [],
          lng: 'de',
          editOptions: 'python-pro-only',
          questScript: '',
