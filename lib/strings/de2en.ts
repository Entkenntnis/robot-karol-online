export const de2en: { [key: string]: string } = {
  ...
  '{n} Marken an der falschen Stelle sind': '{n} marks are in the wrong place',
  '{n} Marken fehlen': '{n} marks missing',
  '{n} Marken zu viel gesetzt sind': '{n} marks are set too many times',
  '{n} Ziegel an der falschen Stelle liegen':
    '{n} bricks are in the wrong place',
  '{n} Ziegel fehlen': '{n} bricks missing',
  '{n} Ziegel zu viel vorhanden sind': '{n} bricks too many',
  '💫 Aufgaben-Galerie': '💫 Task gallery',
  '1 Marke an der falschen Stelle ist': '1 mark is in the wrong place',
  '1 Marke fehlt': '1 mark missing',
  '1 Marke zu viel gesetzt ist': '1 mark is set too many times',
  '1 Ziegel an der falschen Stelle liegt': '1 brick is in the wrong place',
  '1 Ziegel fehlt': '1 brick missing',
  '1 Ziegel zu viel vorhanden ist': '1 brick too many',
  '2D-Ansicht': '2D view',
  abbrechen: 'cancel',
  abgebrochen: 'aborted',
